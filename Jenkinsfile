...
pipeline {
    ...
    environment {
        SERVICE_NAME = 'do-frontend'
        IMAGE_REPO = 'joseptz/do-frontend'
        DOCKERFILE_PATH = 'Dockerfile'
        K8S_DEPLOYMENT_NAME = 'frontend'
        K8S_GREEN_DEPLOYMENT_NAME = 'frontend-green'
        K8S_CONTAINER_NAME = 'frontend'
        K8S_APP_LABEL = 'frontend'
        K8S_STABLE_SERVICE_NAME = 'frontend'
        K8S_NODEPORT_SERVICE_NAME = 'frontend-nodeport'
    }
    ...
    stages {
        ...
        stage('Test') {
            steps {
                powershell '$env:CI="true"; npm test -- --watchAll=false --passWithNoTests'
            }
        }
